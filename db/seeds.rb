...
Organization.new({ name: 'International Association of Fairs and Expositions', primary_contact: 'Jim Tucker', address_line_1: '3043 E Cairo St', city: 'Springfield', state_province: 'MO', zip_code: '65802', phone: '417-862-5771', fair: false, enabled: true }).save
