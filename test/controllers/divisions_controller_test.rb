...
class DivisionsControllerTest < ActionController::TestCase
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post :create, division: { description: @division.description, division_largest: @division.division_largest, division_smallest: @division.division_smallest, name: @division.name }
    end
  ...
  test "should update division" do
    patch :update, id: @division, division: { description: @division.description, division_largest: @division.division_largest, division_smallest: @division.division_smallest, name: @division.name }
    assert_redirected_to division_path(assigns(:division))
  end
