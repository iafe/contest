...
class JudgesControllerTest < ActionController::TestCase
  ...
  test "should create judge" do
    assert_difference('Judge.count') do
      post :create, judge: { category_id: @judge.category_id, division_id: @judge.division_id, user_id: @judge.user_id }
    end
  ...
  test "should update judge" do
    patch :update, id: @judge, judge: { category_id: @judge.category_id, division_id: @judge.division_id, user_id: @judge.user_id }
    assert_redirected_to judge_path(assigns(:judge))
  end
