...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { description: @award.description, enabled: @award.enabled, name: @award.name, rules: @award.rules, sponsor: @award.sponsor, sponsor_logo: @award.sponsor_logo }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { description: @award.description, enabled: @award.enabled, name: @award.name, rules: @award.rules, sponsor: @award.sponsor, sponsor_logo: @award.sponsor_logo }
    assert_redirected_to award_path(assigns(:award))
  end
